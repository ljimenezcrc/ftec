...
SMhablada, SMlogo)
values (
'FTEC', 'param', 'Párametros FTEC', null,
...
update SModulos
set SMdescripcion = 'Párametros FTEC'
,  SMhomeuri = null
,  SMmenu = 1
...
SPpublico, SPinterno)
values (
'FTEC', 'param', 'FTIND', 'Cuentas Indicadores',
'/ftec/catalogos/SaldoCuentaCont.cfm', 1, '20131022 10:02:07.057', 1,
null, null, null, 0,
0, 0)
end else begin 
update SProcesos
set SPdescripcion = 'Cuentas Indicadores'
,  SPhomeuri = '/ftec/catalogos/SaldoCuentaCont.cfm'
,  SPmenu = 1
,  BMfecha = '20131022 10:02:07.057'
,  BMUsucodigo = 1
,  SPorden = null
,  SPhablada = null
,  SPlogo = null
...
print 'SProcesosRol fila: 1 de 12'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 2 de 12'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 3 de 12'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 4 de 12'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 5 de 12'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 6 de 12'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 7 de 12'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 8 de 12'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 9 de 12'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 10 de 12'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 11 de 12'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
commit 
go
print 'SProcesosRol fila: 12 de 12'
declare @n int 
begin tran
select @n = count(1)
from SProcesosRol 
...
,  SPcodigo = null
,  SMNtipoMenu = 1
,  SMNtitulo = 'Parámetros Generales'
,  SMNexplicativo = null
,  SMNorden = 1
,  SMNimagenGrande = null
,  SMNimagenPequena = null
...
select 'Procesos             ' as tipo, count(1) as real, 12 as esperado
from SProcesos
where SScodigo = 'FTEC'
and SMcodigo = 'param' 
go
...
select 'ProcesosRol          ' as tipo, count(1) as real, 12 as esperado
from SProcesosRol
where SScodigo = 'FTEC'
and SMcodigo = 'param' 
go
...
select 'Menues               ' as tipo, count(1) as real, 13 as esperado
from SMenues
where SScodigo = 'FTEC'
and SMcodigo = 'param' 
go
